...
if __name__=='__main__':
    ...
    parser.add_argument('--gen_test', action='store_true', help='Generate test split frustum data with GT 2D boxes')
    ...
    if args.car_only:
        ...
        type_whitelist = ['chair', 'bed', 'toilet', 'couch', 'refrigerator', 'tv', 'indoor-plant', 'dining-table']
    ...
    if args.gen_test:
        print('Start gen_test...')
        imagesets_file = os.path.join(BASE_DIR, 'image_sets/test.txt')
        extract_frustum_data(\
            imagesets_file,
            'testing',
            os.path.join(BASE_DIR, output_prefix+'test.pickle'),
            viz=False, perturb_box2d=False, augmentX=1,
            type_whitelist=type_whitelist,
            with_image=args.with_image)
        get_box3d_dim_statistics(imagesets_file, type_whitelist,'testing')
