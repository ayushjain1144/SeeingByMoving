...
mod = '"new1"' # new dataset
mod = "'new2'" # removed bikes
mod = "'new3'" # use rf instead of svm
mod = "'new4'" 
mod = "'new5'"
mod = "'new6'"
...
exps['trainer'] = [
    'carla_gt', # mode
    #'carla_multiview_train_data', # dataset
    'carla_multiview_25views_new_val',
...
groups['carla_gt'] = ['do_carla_gt = True']
...
groups['carla_multiview_25views_new_train'] = [
    ...
    'H = %d' % H,
    'W = %d' % W,
    'trainset = "viewseg_multiview_mr07_s29_i1_train"', #smabs5i8t
    'trainset_format = "multiview"',
    'trainset_seqlen = %d' % S,
    'dataset_location = "%s"' % dataset_location,
    'dataset_filetype = "npz"'
...
groups['carla_multiview_25views_new_val'] = [
    ...
    'H = %d' % H,
    'W = %d' % W,
    'trainset = "viewseg_multiview_mr07_s29_i1_val"', #smabs5i8t
    'trainset_format = "multiview"',
    'trainset_seqlen = %d' % S,
    'dataset_location = "%s"' % dataset_location,
    'dataset_filetype = "npz"'
...
groups['carla_multiview_25views_new_test'] = [
    ...
    'H = %d' % H,
    'W = %d' % W,
    'trainset = "viewseg_multiview_mr07_s29_i1_test"', #smabs5i8t
    'trainset_format = "multiview"',
    'trainset_seqlen = %d' % S,
    'dataset_location = "%s"' % dataset_location,
    'dataset_filetype = "npz"'
